...
pub const SLASH_COMMANDS: &[SlashCommand] = &[
    ...
    SlashCommand {
        name: "switch",
        desc: "Switch active mailbox (or pick one)",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
    ...
    SlashCommand {
        name: "logout",
        desc: "Clear token + config, then quit",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "login",
        desc: "Re-authenticate (runs the shell-side `postr login` flow)",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "whoami",
        desc: "Show worker URL, email, and mailbox list",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "mailbox-list",
        desc: "List mailboxes known to the worker",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "mailbox-add",
        desc: "Add a mailbox: <addr> [--name N] [--alias A]",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "mailbox-update",
        desc: "Update a mailbox: <addr> [--name N|--clear-name] [--alias A|--clear-alias]",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "mailbox-remove",
        desc: "Remove a mailbox by address",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
    SlashCommand {
        name: "demo-seed",
        desc: "Populate a mailbox with curated demo data",
        scope: Scope::Both,
        status: CmdStatus::Active,
    },
];
